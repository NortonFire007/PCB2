...
//             comments.map((comment, index) => (
//               <div key={index} className="flex mb-4">
//                 <div className="w-1/6 mr-4 flex flex-col items-center justify-center gap-4">
//                   <img
//                     src={API_URL + comment.user_image}
//                     alt={`Аватар юзера ${index}`}
//                     className="w-12 h-12 rounded-full"
...
//                   <div className="flex items-center mb-2">
//                     <DisplayStarRating rating={comment.grade} size={16} />
//                     <span className="ml-2 flex-end">{comment.created_at}</span>
//                   </div>
//                   <p>{comment.text}</p>
//                   <div className="flex mt-2">
//                     <button className="mr-2 border p-1">Like</button>
...
// import { RatingStats, DisplayStarRating } from './index.js';
// import { API_URL } from '../http/index.js';
// import { FaRegCommentDots } from 'react-icons/fa'; // Import an icon for no comments
